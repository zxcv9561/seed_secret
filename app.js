...
/* Apply site-wide font overrides from site_settings
   - font-section-title: 섹션 제목 (페이지 상단 큰 제목)
   - font-sidebar-logo: 사이드바 로고 */
function applySiteFontOverrides() {
  ...
  if (sectionFont && sectionFont.trim()) {
    css += '.section-title, .detail-title {\n' +
           '  font-family: "' + sectionFont.replace(/"/g, '') + '", \'Black Han Sans\', \'Noto Sans KR\', sans-serif !important;\n' +
           '}\n';
  }
...
function renderAboutDetail(view, id) {
  ...
  hdr.innerHTML =
    '<div class="detail-header-row">' +
      '<div class="detail-title" ' + ' data-placeholder="제목 입력">' + esc(item.title) + '</div>' +
...
function renderCaseDetail(view, id) {
  ...
  hdr.innerHTML =
    ...
    '<div class="detail-header-row">' +
      '<div class="detail-title" ' + ' data-placeholder="대상명">' + esc(c.target) + '</div>' +
      '<div class="detail-actions">' +
        favButton('case', c.id) +
        permButton(c, 'case') +
        editToggleButtons(canModify) +
...
function renderDossierDetail(view, id) {
  ...
  hdr.innerHTML =
    ...
    '<div class="detail-header-row">' +
      '<div class="detail-title" ' + ' data-placeholder="보고서 제목">' + esc(d.target) + '</div>' +
      '<div class="detail-actions">' +
...
function renderAgentDetail(view, id) {
  ...
  hdr.innerHTML =
    ...
    '<div class="detail-header-row">' +
      '<div class="detail-title" ' + ' data-placeholder="요원 이름">' + esc(a.name) + '</div>' +
      '<div class="detail-actions">' +
...
function renderClassifiedDetail(view, id) {
  ...
  hdr.innerHTML =
    ...
    '<div class="detail-header-row">' +
      '<div class="detail-title" ' + ' data-placeholder="문서 제목">' + esc(c.title) + '</div>' +
      '<div class="detail-actions">' +
...
function renderPostDetail(view, id) {
  ...
  hdr.innerHTML =
    ...
    '<div class="detail-header-row">' +
      '<div class="detail-title" ' + ' data-placeholder="제목 입력">' + esc(p.title) + '</div>' +
...
function renderSiteFontSettings() {
  ...
  intro.innerHTML =
    '사이트 상단의 <b>섹션 제목</b>과 좌측 <b>사이드바 로고</b> 영역에 사용할 폰트를 지정할 수 있습니다.<br>' +
    '본문 내용에는 영향을 주지 않으며, <b>기본 사용</b>을 선택하면 원래 폰트(Black Han Sans)가 사용됩니다.';
  wrap.appendChild(intro);

  var roles = [
    { key: 'font-section-title', label: '섹션 제목', sub: '페이지 상단 큰 제목 (기관 소개, 사건 일람 등)', dflt: 'Black Han Sans' },
    { key: 'font-sidebar-logo',  label: '사이드바 로고',   sub: '좌측 사이드바의 S.E.E.D. 로고 영역',          dflt: 'Black Han Sans' }
  ];
...
function renderArchiveDetail(view, id) {
  ...
  hdr.innerHTML =
    ...
    '<div class="detail-header-row">' +
      '<div class="detail-title" ' + ' data-placeholder="자료 제목">' + esc(x.title) + '</div>' +
      '<div class="detail-actions">' +
...
function renderLogDetail(view, id) {
  ...
  hdr.innerHTML =
    ...
    '<div class="detail-header-row">' +
      '<div class="detail-title" ' + ' data-placeholder="일지 제목">' + esc(l.title) + '</div>' +
      '<div class="detail-actions">' +
        favButton('log', l.id) +
        permButton(l, 'log') +
        editToggleButtons(canModify) +
